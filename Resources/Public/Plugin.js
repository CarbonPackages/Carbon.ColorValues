...
module.exports = {"wrapper":"ColorValuesEditor__wrapper___3NYbL","feedback":"ColorValuesEditor__feedback___3UxEd","transparent":"ColorValuesEditor__transparent___Ls6St","checkboard":"ColorValuesEditor__checkboard___39kI2","list":"ColorValuesEditor__list___1QCLd","item":"ColorValuesEditor__item___9YGw9","disabled":"ColorValuesEditor__disabled___x_cCT","reset":"ColorValuesEditor__reset___45Sbd"};

/***/ }),

/***/ "./src/ColorValuesEditor.js":
/*!**********************************!*\
  !*** ./src/ColorValuesEditor.js ***!
  \**********************************/
/*! no static exports found */
...
var _ColorValuesEditor = __webpack_require__(/*! ./ColorValuesEditor.css */ "./src/ColorValuesEditor.css");

var _ColorValuesEditor2 = _interopRequireDefault(_ColorValuesEditor);
...
var Editor = (_temp2 = _class = function (_PureComponent) {
    ...
    function Editor() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Editor.__proto__ || Object.getPrototypeOf(Editor)).call.apply(_ref, [this].concat(args))), _this), _this.onReset = function () {
            _this.props.commit("");
        }, _this.getFeedback = function (value) {
            var isTransparent = value == "transparent";
            return [_ColorValuesEditor2.default.feedback, isTransparent && _ColorValuesEditor2.default.transparent, !value && _ColorValuesEditor2.default.checkboard].filter(function (item) {
                return !!item;
            }).join(" ");
    ...
    _createClass(Editor, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                "div",
                { className: options.disabled && _ColorValuesEditor2.default.disabled },
                _react2.default.createElement(
                    "div",
                    { className: _ColorValuesEditor2.default.wrapper },
                    ...
                    allowEmpty && _react2.default.createElement(
                        "div",
                        { className: _ColorValuesEditor2.default.reset },
                        _react2.default.createElement(_reactUiComponents.IconButton, { style: "lighter", icon: "times", title: "Reset", onClick: this.onReset })
                    )
                ),
                _react2.default.createElement(
                    "div",
                    { className: _ColorValuesEditor2.default.list },
                    valueArray.map(function (item) {
                        return _react2.default.createElement("button", {
                            className: [_ColorValuesEditor2.default.item, item.color == "transparent" && _ColorValuesEditor2.default.transparent].join(" "),
                            disabled: item.disabled,
...
var _ColorValuesEditor = __webpack_require__(/*! ./ColorValuesEditor */ "./src/ColorValuesEditor.js");

var _ColorValuesEditor2 = _interopRequireDefault(_ColorValuesEditor);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

(0, _neosUiExtensibility2.default)("Carbon.ColorValues:Editor", {}, function (globalRegistry, _ref) {
    var frontendConfiguration = _ref.frontendConfiguration;

    var editorsRegistry = globalRegistry.get("inspector").get("editors");
    editorsRegistry.set("Carbon.ColorValues/Editor", { component: _ColorValuesEditor2.default });
});
